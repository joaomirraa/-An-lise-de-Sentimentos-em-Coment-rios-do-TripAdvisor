...
#df = pd.read_excel('comentarios_treino_excel.xlsx')
df = pd.read_excel("C:\\Users\\Utilizador\\Desktop\\Projeto\\EntregaFinal_Projeto\\Excel\\comentarios_polaridade.xlsx")
...
# Passo 4: Treinar o Classificador de Regressão Logística
logistic_regression = LogisticRegression(max_iter=500)  # Aumentar max_iter para convergência
...
print("Precisão da Regressão Linear:", accuracy)
...
plt.suptitle('Regressão Linear', fontsize=16)
