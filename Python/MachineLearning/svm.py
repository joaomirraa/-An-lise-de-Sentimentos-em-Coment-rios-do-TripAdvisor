...
# Passo 4: Treinar o Classificador SVM
svm_classifier = SVC(kernel='rbf')  # O kernel linear é frequentemente utilizado para tarefas de classificação de texto
...
print("Precisão do SVM:", accuracy)
...
plt.suptitle('Máquinas de Vetores de Suporte (SVM)', fontsize=16)
